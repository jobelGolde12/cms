  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-brand-50 px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-brand-200 bg-white shadow-xl p-8 text-center">
        ...
        <h1 className="text-xl font-extrabold text-brand-900">Record Verification</h1>
        <p className="mt-2 text-sm text-brand-500">Token: <span className="font-mono text-brand-800">{token}</span></p>
        <p className="mt-3 text-xs text-brand-400">Only minimal permitted information is displayed.</p>
